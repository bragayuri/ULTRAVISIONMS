...
public class AddMusicPanel extends JFrame implements ActionListener {
	...
	public AddMusicPanel() {
		 ...
		 */
		 ...
		 JLabel mylabel = new JLabel("ADD NEW MUSIC");
		 one.add(mylabel);
		...
		JLabel l8 = new JLabel("Rate");
		 ...
		 JLabel l10 = new JLabel("MUSIC GENRE");
		 eleven.add(l10);
